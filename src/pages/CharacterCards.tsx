...
export default function CharacterCards() {
  ...
  const exportCharacter = (character: Character) => {
    ...
    if (ctx) {
      ...
      ctx.fillText(character.name, canvas.width / 2, 40);
      ...
      const wrapText = (text: string, y: number, lineHeight: number) => {
      ...
      ctx.fillText('Description:', 20, y);
      y += 20;
      ctx.font = '14px Arial';
      y = wrapText(character.description, y, 20);

      y += 20;
      ctx.font = 'bold 16px Arial';
      ctx.fillText('Appearance:', 20, y);
      y += 20;
      ctx.font = '14px Arial';
      y = wrapText(character.appearance, y, 20);

      y += 20;
      ctx.font = 'bold 16px Arial';
      ctx.fillText('Personality:', 20, y);
      y += 20;
      ctx.font = '14px Arial';
      y = wrapText(character.personality, y, 20);
